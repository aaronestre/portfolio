...
export default function Navbar() {
    ...
    return (
        <div className="sticky top-2 mx-auto h-13 flex justify-center items-center rounded-2xl min-w-[410px] font-(family-name:--secondary-font) w-3/10 shadow-2xl bg-(--background-semi-dark) z-1 border-2 border-gray-400/50 border-solid">
